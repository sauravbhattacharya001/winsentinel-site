...
(function () {
  ...
  if (header) {
    header.outerHTML = [
      ...
      '      <a href="/vs/nessus" class="hover:text-white">Compare</a>',
  ...
  if (footer) {
    footer.outerHTML = [
      ...
      '      <a href="/pricing" class="hover:text-white">Pricing</a>',
      '      <a href="/blog" class="hover:text-white">Blog</a>',
      '      <a href="/vs/nessus" class="hover:text-white">vs Nessus</a>',
      '      <a href="/vs/crowdstrike" class="hover:text-white">vs CrowdStrike</a>',
      '      <a href="/vs/tanium" class="hover:text-white">vs Tanium</a>',
      '      <a href="/vs/ninjaone" class="hover:text-white">vs NinjaOne</a>',
